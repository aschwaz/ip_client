                                ...
                                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                    ...
                                    <div className="hidden sm:ml-6 sm:block">
                                        <div className="flex space-x-4">
                                            ...
                                            {/* WILL NEED TO ADD ONCLICK TO CHANGE COLOR USING item.current? .. */}
                                            <a href='/businesses' className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                                                Businesses
                                            </a>
                                            <a href='/1' className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                                                Biz
                                            </a>
                                            <a href='/1/lead' className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                                                Lead
                                            </a>
                                            <a href='/1/info' className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                                                Info
                                            </a>
                                            <a href='/signup' className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                                                Signup
                                            </a>
                                            <a href='/login' className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">
                                                Login
                                            </a>
            ...
            <footer className="bg-white">
                <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
                    ...
                    <div className="mt-8 md:order-1 md:mt-0">
                        ...
                        &copy; 2023 InstaPitch, Inc. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
