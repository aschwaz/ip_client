// import FounderVideo from "../assets/rejigfounder.mp4"

const FounderVideo = "https://www.youtube.com/"

const people = [
    {
      name: 'Meet the Founder',
      role: 'Take some time to hear the mission and vision directly from the team',
      imageUrl: FounderVideo,
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      name: 'Product Walkthrough',
      role: 'Review this video so you can confidently explain how to get started with clients',
      imageUrl: FounderVideo,
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      name: 'Open Call Examples',
      role: 'Listen to a compilation of open calls',
      imageUrl: FounderVideo,
      twitterUrl: '#',
      linkedinUrl: '#',
    },
    {
      name: 'Demo Call Examples',
      role: 'Listen to a demo call with a client that signs up',
      imageUrl: FounderVideo,
      twitterUrl: '#',
      linkedinUrl: '#',
      },
        ...
        <div className="bg-white py-6 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                >
                    {people.map((person) => (
                    <li key={person.name}>
                        <video className="aspect-[3/2] w-full rounded-2xl object-cover" src={person.imageUrl} alt="broken" controls></video>
